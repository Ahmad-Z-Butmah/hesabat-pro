"""drop customers entity (customers are derived from unit sales buyers)

Revision ID: 9d1e5f7a3c2b
Revises: 7b4c9e2a8f1d
...
revision = '9d1e5f7a3c2b'
down_revision = '7b4c9e2a8f1d'
branch_labels = None
depends_on = None
